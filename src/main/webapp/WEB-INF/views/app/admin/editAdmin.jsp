                            ...
                            <div class="card-body">
                                ...
                                <form:form method="post" modelAttribute="admin">
                                    <div class="form-group">
                                        <form:label path="username">Nazwa administratora</form:label><br />
                                    ...
                                    <div class="form-group">
                                        <form:label path="active">Czy użytkownik jest aktywny</form:label><br />
                                        <form:radiobutton path="active" value="true"/>Aktywny<br />
                                        <form:radiobutton path="active" value="false"/>Nieaktywny<br />
                                    </div>
