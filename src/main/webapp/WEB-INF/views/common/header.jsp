...
<header>
    <nav class="container container--70">
        <ul class="nav--actions">
            <li><a href="/app/home" class="btn btn--small btn--without-border">Zaloguj</a></li>
        ...
        <ul>
            ...
            <li><a href="${pageContext.request.contextPath}/donationForm" class="btn btn--without-border">Przekaż dary</a></li>
