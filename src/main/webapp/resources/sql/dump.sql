...
INSERT INTO `charity-donation`.donation (id, city, phone_number, pick_up_comment, pick_up_date, pick_up_time, quantity, street, zip_code, institution_id) VALUES (1, 'Cracow', 600600600, 'Great package', '2020-09-15', '15:00:00', 5, 'Raclawicka', '00-000', null);
INSERT INTO `charity-donation`.donation (id, city, phone_number, pick_up_comment, pick_up_date, pick_up_time, quantity, street, zip_code, institution_id) VALUES (2, 'Kielce', 600700800, 'Super package', '2020-09-11', '10:00:00', 2, 'Radomska', '00-000', null);
